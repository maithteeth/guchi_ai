            ...
            <header className="fixed top-0 w-full z-50 bg-[#0A0F1C]/80 backdrop-blur-md border-b border-white/10">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex gap-8 text-sm font-medium text-slate-300">
                        <a href="#top" className="hover:text-white transition-colors">LP トップ</a>
                        <a href="#demo" className="hover:text-white transition-colors">インタラクティブ体験</a>
                        <a href="#core-value" className="hover:text-white transition-colors">組織が変わる理由</a>
                        <a href="#architecture" className="hover:text-white transition-colors">システム構成</a>
                        <a href="#roi" className="hover:text-white transition-colors">導入効果・ROI</a>
                    </nav>
                    <div className="flex gap-4">
                        <Link href="http://localhost:8503" target="_blank" className="hidden md:flex items-center justify-center px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors">
                            経営者ログイン (Front B)
                        </Link>
